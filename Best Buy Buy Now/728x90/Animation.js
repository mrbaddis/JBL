home_animation = (function() {
	...
	function frame1()
	{
		...
		//headphones rotate
		TweenLite.to(black_headphone_1, 1.8, {left:260,rotationY:180, delay:1.2, ease: Expo.easeOut});

		//blur image fades in
		TweenLite.to(black_headphone_blur_right, 1.9, {left:30,opacity:1, delay:1.3, ease: Expo.easeOut});	
		
		//wire falls off
		TweenLite.to(wire, 4.5, {top:120, left:350, rotationY:180, delay:1.2});	

		//blur fades out
		TweenLite.to(black_headphone_blur_right, 1.2, {opacity:0, delay:1.4, ease: Expo.easeOut});
		//headphones in final position
		TweenLite.to(black_headphone_left, 1, {opacity:1, delay:1.4, ease: Expo.easeOut});	
		TweenLite.to(black_headphone_left, .8, {left:200, delay:1.4, ease: Expo.easeOut});	
		TweenLite.to(black_headphone_1, .2, {opacity:0, delay:1.4, ease: Expo.easeOut});	
   ...
   var x;
	...
	{	
		...
		TweenLite.to(white_headphone, 0.8, {left:219, opacity:1, delay:0.3 });

		TweenLite.to(jbl_logos, 0.3, {opacity:0, delay:0});
		TweenLite.to(for_music_text, 0.3, {opacity:0, delay:0});
		TweenLite.to(jbl_everest_logo, 0.8, {left:0, opacity:1, delay:0.3 });
		TweenLite.to(learnMore, 0.8, {opacity:1, delay:0.5 });
		TweenLite.to(bestbuy_logo, 0.8, {opacity:1, delay:0.8 });
